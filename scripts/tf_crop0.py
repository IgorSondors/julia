...
df['spoof'] = spoofs
df.to_csv('/home/ubuntu/camera_spoofing/lossless_unified/train_10random_crops0.csv', index=False)

df_error = pd.DataFrame({'error_file': error_pths})
df_error.to_csv('/home/ubuntu/camera_spoofing/lossless_unified/train_errors0.csv', index=False)
