...
source = '/mnt/data/lossless_train_04102022/0'
...
final_destination = '/mnt/data/lossless_train_04102022_crops'
...
df['spoof'] = spoofs
df.to_csv('/mnt/data/lossless_train_04102022_crops0.csv', index=False)
