...
if __name__ == '__main__':
    ...
    initial_lr = 0.0017
    min_lr = 0.0000001
    dst_pth = 'path_to_the_folder_for_weights_and_tensorboard_saving'
    csv_train = 'path_to_the_csv_with_paths_and_labels'
    csv_test = 'path_to_the_csv_with_paths_and_labels'
