...
def build_shared_plain_network(input_image, mode, using_SE=True):
    ...
    if mode=='rgb':
        ...
        wn = Lambda(regular_norm, name="regular_norm{}".format(mode))(input_image)
        print('np.shape(wn) = ', np.shape(wn))
...
if __name__ == '__main__':
    ...
    initial_lr = 0.0017
    min_lr = 0.0000001
    dst_pth = '/home/yandex/igor/julia/dct_bigger_batch_mixed_float16'
