...
def BRA_conv_conv(input):
    ...
    return AveragePooling2D(pool_size=(2, 2), strides=(2, 2))(activation02)
...
def build_shared_plain_network(input_image, mode, using_SE=True):
    ...
    block1 = BRA_conv_conv(input=dct)
...
if __name__ == '__main__':
    ...
    initial_lr = 0.0017
    min_lr = 0.0000001
    dst_pth = '/home/ubuntu/camera_spoofing/julia/ivan_experiment/conv_bn_act/conv_before_pooling/conv_conv'
    ...
    model,
    to_file="{}/conv_conv.png".format(dst_pth),
    show_shapes=True,
    show_dtype=False,
