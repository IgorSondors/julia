...
def BRA_convX3(input):
    ...
    return AveragePooling2D(pool_size=(2, 2), strides=(2, 2))(activation03)
...
if __name__ == '__main__':
    ...
    initial_lr = 0.0017
    min_lr = 0.0000001
    dst_pth = '/home/ubuntu/camera_spoofing/julia/ivan_experiment/conv_bn_act/conv_before_pooling/convX3'
    ...
    model,
    to_file="{}/convX3.png".format(dst_pth),
    show_shapes=True,
    show_dtype=False,
