...
def BRA_convX4(input):
    conv01 = Conv2D(32, (3, 3), use_bias=False)(input)
    bn01 = BatchNormalization()(conv01)
    activation01 = Activation('swish')(bn01)

    conv02 = Conv2D(32, (3, 3), use_bias=False)(activation01)
    bn02 = BatchNormalization()(conv02)
    activation02 = Activation('swish')(bn02)

    conv03 = Conv2D(32, (3, 3), use_bias=False)(activation02)
    bn03 = BatchNormalization()(conv03)
    activation03 = Activation('swish')(bn03)

    conv04 = Conv2D(32, (3, 3), use_bias=False)(activation03)
    bn04 = BatchNormalization()(conv04)
    activation04 = Activation('swish')(bn04)

    return AveragePooling2D(pool_size=(2, 2), strides=(2, 2))(activation04)
...
if __name__ == '__main__':
    ...
    initial_lr = 0.0017
    min_lr = 0.0000001
    dst_pth = '/home/ubuntu/camera_spoofing/julia/ivan_experiment/conv_bn_act/conv_before_pooling/convX4'
